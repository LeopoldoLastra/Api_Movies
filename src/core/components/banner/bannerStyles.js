...
export const useBannerStyles = () =>{
    ...
    let stylesImg;
    if(width>761){
        stylesSwiper={overflow:'hidden', margin:'10px auto', minHeight: 400, borderRadius:'16px'}
        ...
        stylesSlide={width: '100%', height:'100%', backgroundColor: '#121212', display:'grid', gridTemplateColumns:'30% 1fr', overflow:'hidden', alignContent:'center'}
        stylesImg={objectFit:'stretch', width:'100%', maxHeight:'100%', objectPosition:'50% 30px'}
